...
protocol BlogFirstTableViewCellDelegate: AnyObject {
   // func didTapRelatedPostButton(model: UserNotification)
    func didTapService()
}

class BlogFirstTableViewCell: UITableViewCell {

                    static let identifier = "BlogFirstTableViewCell"
                    
                    weak var delegate: BlogFirstTableViewCellDelegate?
