//
//  ActionSecondTableViewCell.swift
...
protocol ActionSecondTableViewCellDelegate: AnyObject {
   // func didTapRelatedPostButton(model: UserNotification)
    func didTapService()
}


class ActionSecondTableViewCell: UITableViewCell {


        
                    static let identifier = "ActionSecondTableViewCell"
                    
                    weak var delegate: ActionSecondTableViewCellDelegate?
                ...
                private let mainLabel: UILabel = {
                    ...
                    label.text = "Список акций (collectionView)"
                    return label
                }()
