//
//  ActionFirstTableViewCell.swift
...
protocol ActionFirstTableViewCellDelegate: AnyObject {
   // func didTapRelatedPostButton(model: UserNotification)
    func didTapService()
}

class ActionFirstTableViewCell: UITableViewCell {

                static let identifier = "ActionFirstTableViewCell"
                
                weak var delegate: ActionFirstTableViewCellDelegate?
